...
if num < 1000:
    ...
    print(num,"=",num_cem,"centenas",",",num_dez,"dezenas","e",num_unid,"unidades")

else:
    print("O numero é maior que 1000, o programa não pode ser executado.")
